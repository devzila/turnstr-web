...
top:"42%",zIndex:1,display:"inline-block",padding:"1.2em",borderTop:"1px solid #000",borderLeft:"1px solid #000",boxShadow:"2px 2px 0 rgba(255,255,255,0.9) inset",cursor:"pointer"}).hide();q.on("click",function(){l=Math.round(c/f);m=l-1;w.run(a.animation,m);g("video").each(function () { this.pause() });});r.on("click",function(){l=Math.round(c/f);m=l+1;w.run(a.animation,m);g("video").each(function () { this.pause() });});d.on("mouseenter touchstart",function(){q.add(r).fadeIn()}).on("mouseleave touchcancel",function(){q.add(r).fadeOut()});g(document).on("keydown",function(a){var b=d[0].getBoundingClientRect();(b=0<b.bottom&&0<b.right&&b.left<
